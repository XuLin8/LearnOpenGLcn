...
int main()
{
    ...
    Shader shader(
        "res/Shaders/AdvancedLights/6.lighting.vs",
        "res/Shaders/AdvancedLights/6.lighting.fs");
    Shader hdrShader(
        "res/Shaders/AdvancedLights/6.hdr.vs",
        "res/Shaders/AdvancedLights/6.hdr.fs");
